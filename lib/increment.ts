...
export class IncrementVersion extends FulfillableGoal {
    ...
    constructor(goalDetailsOrUniqueName: FulfillableGoalDetails | string = DefaultGoalNameGenerator.generateName("increment-version"),
                ...dependsOn: Goal[]) {
        ...
        super({
            ...
            ...getGoalDefinitionFrom(goalDetailsOrUniqueName, DefaultGoalNameGenerator.generateName("increment-version")),
